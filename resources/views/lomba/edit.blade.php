...
<section class="main-section">
    ...
    <div class="content">
        <div class="content-info-up">
            <h3>Form Edit Lomba </h3>
            
        </div>
        <hr>
        <div class="row">
            <div class="col-md-4 col-sm-8 col-xs-12">
            <form action="{{route('lomba.update', [$lomba->id_lomba])}}" method="POST" class="form-horizontal" role="form">
            {{ csrf_field() }}
            {{method_field('patch')}}

                <div class="form-group {{ $errors->has('nama_lomba') ? ' has-error' : '' }}">
                    <label class="control-label" for="nama_lomba">Nama Lomba</label>
                    <input class="form-control" type="text" name="nama_lomba" id="nama_lomba" value="{{$lomba->nama_lomba}}" placeholder="Nama Lomba" required="reuired">
                ...
                <div class="form-group {{ $errors->has('waktu') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" type="text" name="waktu" id="waktu" value="{{$lomba->waktu}}" placeholder="Waktu Lomba" required="reuired">
                ...
                <div class="form-group {{ $errors->has('keterangan') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control" type="text" name="keterangan" id="keterangan" value="{{$lomba->keterangan}}" placeholder="Keterangan Lomba" required="reuired">
